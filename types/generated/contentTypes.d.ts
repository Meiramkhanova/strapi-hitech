...
export interface ApiAboutpageAboutpage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    first_section_description: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    first_section_title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiKnowledgepageKnowledgepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    main_section_decscription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yaizy_description: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    yaizy_image: Schema.Attribute.Media<
    ...
    yaizy_title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTabTab extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tab_contents: Schema.Attribute.Relation<
      'oneToMany',
      'api::tab-content.tab-content'
    >;
    title: Schema.Attribute.String &
